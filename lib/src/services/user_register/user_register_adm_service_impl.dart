...
import 'package:app_barbershop/src/services/user_register/user_register_adm_service.dart';
...
class UserRegisterAdmServiceImpl implements UserRegisterAdmService {
  ...
  UserRegisterAdmServiceImpl({required this.userRepository, required this.userLoginService});
  @override
